...
function [posSelection, taskPrediction, curPs, expectedEntropy, simPos, simSteps, simSteps_ratio, curCostss, prederr,cuedEntropy,interaction] = Model(trueSeqs, probeSeqs, paras, imodel)
% usage: [posSelection, taskPrediction, curP, expectedEntropy, simPos, simSteps, simSteps_ratio, curCosts] = Model(trueSeqs, probeSeqs, paras, imodel)
% imodel: 
% 1: base model
% 2: interaction
% 3: sim_mem_pos1
