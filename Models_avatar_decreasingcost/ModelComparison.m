function [AICs, betas, predictedRT,numFreePara,intreg,dm,regnames,LLs] = ModelComparison(x, trueSeqs, probeSeqs, behChoice, behCorrect, behRT, imodel, nreplay0)

[y,dm,noEnt,intreg] = ModelCostFunction(x, trueSeqs, probeSeqs, behChoice, behCorrect, behRT, imodel, nreplay0);
y = sqrt(y);
...
elseif ismember(imodel, [4,9]) %rep+mem+pos1+interaction   %%!!
